...
IMPORTANT2: The different between this script and the one before is that it
was done based on the "txtfilesv2", a new version of the files convertion (see
converting_files_v2.py).
"""
...
for txt in txt_files:
    os.chdir('C:/Users/Usuário/Projects/monografia/dados/txt_filesv2')
    ...
    with io.open(txt, 'r', encoding='utf-8') as text:
        ...
        if len(texto_div) > 1:
            ...
            texto_update = texto_final.lower()
